...
A lightweight terminal log viewer for Docker containers. The agent runs on your
...
- Level filter (`l`) — ALL / DEBUG / INFO / LOG / WARN / ERROR
...
#### Via SSH tunnel (recommended as of now)
